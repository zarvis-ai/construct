...
Anthropic, Google Gemini, or a local Ollama directly, and can also draw on your
Codex or Claude (Pro/Max) subscription. Smith runs its own agent loop with
...
`specs/0030-claude-oauth-direct-api.md`.

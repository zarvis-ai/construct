...
- It does not make the preview persistent, pinned, or interactive; it is a transient hover affordance. (Superseded for the clip-chip hover card specifically by `0090`, which lets a click pin *that* card into a live, keyboard-focused terminal; the shimmer-text hover card described in this spec is unaffected and remains transient.)
